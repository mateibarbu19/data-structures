...
#define MAXB 11
#define MAXM (1 << MAXB)
#define MASK_MAXB_BITS (MAXM - 1)
#define MASK_FIRST_MAXB_BITS (MASK_MAXB_BITS << (NR_BITS_IN_INT - MAXB))

#define ALPHA ((double)(0.7213 / (1.0 + (1.079 / MAXM))))
